...
@Outcome(id = "1, 0, 1", expect = Expect.FORBIDDEN, desc = "b=1, then a=0")
@Outcome(id = "1, 0, 2", expect = Expect.FORBIDDEN, desc = "b=1, then a=0")
...
@Outcome(id = "2, 0, 2", expect = Expect.FORBIDDEN, desc = "b=2, then a=0")
...
@State
public class AtomicIntegerSetGetAckRelTest {
